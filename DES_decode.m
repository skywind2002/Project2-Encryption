function [secret] = DES_decode(message, SubKeyList, IP, IPInv, Ext, S, P)
  % DES解密程序，根据密文message和密钥生成的子密钥SubKeyList生成密文，剩下的都是需要的常数
  ...
  for i = 1:16 %迭代计算16次
      ...
      tmp = xor(tmp, SubKeyList(17-i,:)); %与子密钥异或  (与Encode相比唯一变化)
      tmp1=zeros(1,32);
      for k = 1:8 %S变换,6位一组
